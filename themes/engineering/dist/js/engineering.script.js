...
(function ($, Drupal) {
  Drupal.behaviors.engineeringNewsSocialMedia = {
    attach: function attach(context, settings) {
      ...
      $('.news-social-media', context).prepend('<div class="widget-wrapper-copylink"><a href="" class="su-news-header__copylink share-copylink">' + copyLinkIcon + '</a><span>Copy Link</span></div>');
