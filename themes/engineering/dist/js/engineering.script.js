...
(function ($, Drupal) {
  Drupal.behaviors.engineeringNewsSocialMedia = {
    attach: function attach(context, settings) {
      ...
      var copiedUrlText = '<span class="copied-url">Copy Link</span>';
      var copiedUrlSuccessText = '<span class="copied-url-success">Copied!</span>';
      var copiedUrlFailedText = '<span class="copied-url-failed">Copy failed</span>';
      $('.news-social-media', context).empty();
      $('.news-social-media', context).prepend('<div class="widget-wrapper-print"><a href="/' + settings.path.currentPath + '/printable/print" class="share-print su-news-header__social-print">' + printIcon + '</a><span>Print</span></div>');
      $('.news-social-media', context).prepend('<div class="widget-wrapper-copylink"><a href="" class="su-news-header__copylink share-copylink">' + copyLinkIcon + '</a>' + copiedUrlText + '</div>');
