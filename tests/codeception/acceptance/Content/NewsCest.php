...
class NewsCest {
  ...
  private function testRelatedNewsPerson(AcceptanceTester $I) {
   ...
   * contributor roles.
   *
   * We don't use the news variant for Engineering, so disabling.
   */
  #[CodeceptionAttribute\Group('news_variant')]
  private function testNewsVariantFieldsDisplay(AcceptanceTester $I) {
  ...
  private function testRoleCanSelectSpotlightVariant(AcceptanceTester $I, Example $example) {
   ...
   *
   * Engineering uses different spotlights, so disabling.
   */
  #[CodeceptionAttribute\Group('news_variant')]
  private function testRelatedSpotlightsFiltersByTaxonomy(AcceptanceTester $I) {
  ...
  private function testSpotlightCreationAndDisplay(AcceptanceTester $I) {
  ...
  private function testUnpublishedTerms(AcceptanceTester $I) {
    $term = $I->createEntity([
      'vid' => 'stanford_news_topics',
