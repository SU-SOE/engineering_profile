...
namespace Drupal\engineering_profile\Config;
 ...
 *
 * @package Drupal\engineering_profile\Config
 */
class ConfigOverrides implements ConfigFactoryOverrideInterface {
  ...
  public function loadOverrides($names) {
    ...
    if (in_array('system.site', $names)) {
      $overrides['system.site']['page'] = [
        403 => $this->state->get('engineering_profile.403_page'),
        404 => $this->state->get('engineering_profile.404_page'),
        'front' => $this->state->get('engineering_profile.front_page'),
      ];
    }
  ...
  public function getCacheSuffix() {
    return 'EngineeringProfileConfigOverride';
  }
